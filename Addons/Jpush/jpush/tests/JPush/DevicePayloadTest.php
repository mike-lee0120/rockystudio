...
class DevicePayloadTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testGetDevicesWithInvalidRid()
    {
        $response = $this->device->getDevices('INVALID_REGISTRATION_ID');
    }

    public function testUpdateDevicesAlias()
    {
        global $registration_id;
    ...
    public function testUpdateDevicesTags()
    {
        global $registration_id;
    ...
    public function testIsDeviceInTag()
    {
        global $registration_id;
    ...
    public function testGetAliasDevices()
    {
        $test_tag = $this->test_tag;
