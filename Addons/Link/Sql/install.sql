...
VALUES
  (1, '青云', '/Addons/Link/img/qingcloud.png', 'http://qingcloud.com', 2, 1481175884, 1481175884, 0, 1),
  (2, '氪空间', '/Addons/Link/img/krspace.png', 'http://krspace.cn', 2, 1481175884, 1481175884, 0, 1),
  (3, '阿里云', '/Addons/Link/img/aliyun.png', 'http://aliyun.com', 2, 1481175884, 1481175884, 0, 1),
  (4, 'Coding', '/Addons/Link/img/coding.png', 'http://coding.net', 2, 1481175884, 1481175884, 0, 1),
  (5, '七牛云', '/Addons/Link/img/qiniu.png', 'http://qiniu.com', 2, 1481175884, 1481175884, 0, 1),
  (6, 'Ucloud', '/Addons/Link/img/ucloud.png', 'http://ucloud.cn', 2, 1481175884, 1481175884, 0, 1),
  (7, '开源中国', '/Addons/Link/img/oschina.png', 'http://oschina.net', 2, 1481175884, 1481175884, 0, 1),
  (8, '极光推送', '/Addons/Link/img/jiguang.png', 'http://jiguang.cn', 2, 1481175884, 1481175884, 0, 1),
