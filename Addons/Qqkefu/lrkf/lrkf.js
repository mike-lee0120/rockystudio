        ...
        function init(){
                ...
                if(!opts.diyCon){
                    $.each(opts.qqs,function (i,o) {
                        $kfList.append("<li class=qq><a target=_blank href=http://wpa.qq.com/msgrd?v=3&uin="+o.qq+"&site=qq&menu=yes><img src="+opts.root+"img/qq.gif>"+o.name+"</a></li>");
                    });
                    if(opts.tel){
