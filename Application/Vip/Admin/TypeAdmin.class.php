...
class TypeAdmin extends AdminController
{
    ...
    public function index()
    {
        ...
        $builder->setMetaTitle("列表") // 设置页面标题
            ...
            ->addTableColumn("level", "VIP等级")
            ->addTableColumn("title", "会员类型")
    ...
    public function add()
    {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle("新增") // 设置页面标题
                ...
                ->addFormItem("level", "num", "VIP等级", "VIP等级")
                ->addFormItem("title", "text", "会员类型", "会员类型")
                ->addFormItem("price", "price", "价格", "价格")
                ->addFormItem("content", "textarea", "VIP特权", "VIP特权列表")
                ->display();
        }
    }
