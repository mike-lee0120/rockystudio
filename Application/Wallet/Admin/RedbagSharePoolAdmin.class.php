 ...
 * @author jry <598821125@qq.com>
 */
class RedbagSharePoolAdmin extends AdminController
{
    /**
     * 默认方法
     * @author jry <598821125@qq.com>
    ...
    public function index()
    {
        ...
        $p             = input('get.p', 1);
        $model_object  = D("RedbagSharePool");
        ...
        $builder->setMetaTitle("红包随机列表") // 设置页面标题
    ...
    public function edit($id)
    {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle("编辑") // 设置页面标题
                ...
                ->addFormItem("expire", "num", "过期时间", "过期时间/天")
                ->addFormItem("limit", "num", "最低消费", "最低消费")
                ->setFormData(D("RedbagSharePool")->find($id))
                ->display();
        }
    }
}
