 ...
 * @author jry <598821125@qq.com>
 */
class QunAdmin extends AdminController
{
    /**
     * 默认方法
     * @author jry <598821125@qq.com>
    ...
    public function add()
    {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle("新增") // 设置页面标题
                ...
                ->addFormItem("title", "text", "群名称", "群名称")
                ->addFormItem("abstract", "textarea", "群简介", "群简介")
                ->addFormItem("cover", "picture", "群logo", "群logo")
                ->display();
        }
    }
