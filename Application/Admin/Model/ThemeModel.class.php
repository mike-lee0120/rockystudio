        ...
        foreach ($theme_list as &$val) {
            switch ($val['status']) {
                ...
                default:
                    ...
                    if ($val['current']) {
                        $val['right_button']['current']['title']     = '<span>正在使用</span> <i class="fa fa-refresh fa-spin"></i>';
                        $val['right_button']['current']['attribute'] = 'class="label label-success label-pill" href="#"';
                    } else {
                        $val['right_button']['set_current']['title']     = '使用该主题';
                        $val['right_button']['set_current']['attribute'] = 'class="label label-primary label-pill ajax-get" href="' . U('setCurrent', array('id' => $val['id'])) . '"';
                    }
