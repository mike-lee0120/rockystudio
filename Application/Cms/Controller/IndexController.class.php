...
class IndexController extends HomeController
{
    ...
    {
        $this->assign('_index_cate', \lyf\Str::parseAttr(C('cms_config.cate'))); // 获取首页栏目自定义配置
        $this->assign('meta_title', '门户');
        $this->display();
    }
    ...
    public function lists($cid)
    {
        ...
        $document_list = D('Index')
            ->page($_GET["p"] ?: 1, C('ADMIN_PAGE_ROWS'))
        ...
        $this->assign('data_list', $document_list);
    ...
    public function my()
    {
        ...
        $document_list = D('Index')->page($_GET["p"] ?: 1, C('ADMIN_PAGE_ROWS'))
    ...
    public function update()
    {
        ...
        if (!$result) {
            ...
            $this->success($message, cookie('forward') ?: C('HOME_PAGE'));
        }
    }
    ...
    public function detail($id)
    {
        ...
        $comment_list         = D("Cms/Comment")->getCommentList($id, 10, $comment_p, $comment_order);
        ...
        $this->assign('_current_category', $info['category_info']);
